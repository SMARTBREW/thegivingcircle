...
const NGO_LIST = [
  ...
  // { rank: 2, name: 'JWP', cause: 'Child Welfare & Education', location: 'Delhi NCR', description: 'Education and community welfare with a strong focus on girl child education and safe childhood.', href: '/jwp-cause-details', score: 96 },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEOHead
        ...
        keywords="top verified NGOs 2026, top NGO, best NGO, best charities 2026, trusted NGOs, donate to NGO, most transparent NGOs, highest rated charities, highest charity donors, ngo role, role of ngo"
