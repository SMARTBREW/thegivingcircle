      ...
      <div className="container max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            {[
              { rank: 1, name: 'JWP – Jeevan Wahi Phool', cause: 'Child Education', description: 'Operates across multiple Delhi colonies providing after-school tutoring, digital literacy and life skills training. Strong girl child education focus.', impact: '800+ children supported annually', founded: '2011', href: '/jwp-cause-details' },
