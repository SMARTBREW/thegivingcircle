  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        description="Support verified NGOs across India Donate for education, medical treatment, hunger relief, disaster response and animal welfare with transparency"
