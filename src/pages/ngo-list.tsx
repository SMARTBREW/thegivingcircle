...
export const NGOList: React.FC = () => {
  ...
  const ngos: NGO[] = [
    ...
    },
    {
      ...
      description: 'Dedicated to animal welfare, rescue operations, and emergency response for animals in need across India. We work tirelessly to rescue, rehabilitate, and provide medical care to street animals, while also responding to natural disasters and emergency situations. Our programs include daily feeding initiatives, vaccination campaigns, sterilization programs, and emergency rescue operations during floods and other disasters.',
      verified: true,
      logo: '/Animal care.jpg',

      location: 'Delhi NCR',
      causes: ['Animal Welfare', 'Emergency Response', 'Feeding Programs'],
      yearEstablished: 2015,
      impactMetrics: [
        { label: 'Animals Helped', value: 50000, unit: 'animals' },
        { label: 'Emergency Operations', value: 100, unit: 'operations' },
        { label: 'Community Programs', value: 1000, unit: 'programs' },
      ],
