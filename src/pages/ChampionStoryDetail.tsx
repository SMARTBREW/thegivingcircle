  ...
  return (
    <main className="min-h-screen bg-gray-50 flex items-center justify-center">
      <SEOHead
        ...
        keywords="champion stories, impact stories, success stories, giving platform, community support platform, giving community, social giving, community support, support social causes, give and help, causes to support, giving pledge, act of kindness, community helpers, empowering youth, fundraising meaning"
