...
const VerifiedNGOInNoida: React.FC = () => {
  return (
    <LocationSEOBase
      ...
      keywords="verified NGOs in Noida, authenticated NGOs Noida, ngo in noida, charity in noida, social service noida, giving platform, community support, social giving, support social causes, give and help, donation 80g"
