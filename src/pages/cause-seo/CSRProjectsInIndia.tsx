  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEOHead
        ...
        keywords="CSR projects India, csr by indian companies, csr initiatives of indian companies, csr funding means, csr funds meaning, why csr is important, csr for education, corporate social responsibility India, Schedule VII CSR, CSR donation India, CSR NGO partnership India, CSR compliance India, women empowerment CSR"
