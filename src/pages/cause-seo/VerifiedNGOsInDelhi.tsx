        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              // { name: 'JWP', cause: 'Education & Welfare', description: 'Holistic education and community welfare programmes across Delhi NCR with a focus on girl child education.', href: '/jwp-cause-details' },
