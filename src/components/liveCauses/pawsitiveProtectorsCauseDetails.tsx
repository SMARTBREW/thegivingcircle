  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEOHead
        ...
        keywords="rabies prevention, how to prevent rabies, rabies vaccine india cost, anti rabies vaccine price, rabies vaccination, animal welfare ngo, stray dog vaccination programs, donate for stray dog vaccination, anti rabies vaccine for dogs, support street dog vaccination drive, deaths from dog bites, save street dogs, fund rabies prevention campaign, contribute to rabies control program, protect community from rabies, help vaccinate street dogs, make your city rabies free, support public health vaccination drive, animal vaccination clinic, sponsor rabies awareness camps, CSR for animal welfare, CSR project for rabies control, corporate partnership for stray dog vaccination, donate for rabies vaccination drive near me, animal vaccination NGO donation, benefits of a vaccine, vaccination importance"
