...
const CauseDetailPage = () => {
  ...
  const ngoDetails = {
    name: 'JWP',
    logo: 'https://res.cloudinary.com/dcdhhylin/image/upload/v1758183056/images/jwp/_DSC9767.jpg',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEOHead
        ...
        keywords="Wings Of Hope, education, children, verified charity, donate to NGO, transparent charity, impact stories, causes to support, community causes, community giving, community support platform, corporate giving platforms, give and help, giving circle, giving platform, social giving, support social causes, community care, ngo for education, donors for education, fund child education, 80g donation limit, food donation, help in suffering, act of kindness"
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6 md:p-8">
                ...
                <div className="space-y-4 pt-6 border-t border-gray-200">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <a href="https://www.jwp.org" target="_blank" rel="noopener noreferrer" className="text-sm sm:text-base text-gray-700 hover:text-green-700 hover:underline">www.jwp.org</a>
                  </div>
                </div>
              </div>
            </section>
