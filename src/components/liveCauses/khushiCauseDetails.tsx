              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center mb-6 sm:mb-8">
                <div>
                  <p className="text-gray-600 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
                    ...
                    While we directly serve 500 children aged 3-18 with comprehensive education and development support, 
                    the benefits extend far beyond these primary beneficiaries.
                  </p>
                  <p className="text-gray-600 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
                    Over 1,500 family members experience improved quality of life as children gain education and parents 
                    access skill development programs. When children attend school regularly and parents learn new skills, 
                    household incomes increase by an average of 50%, breaking the cycle of poverty.
                  </p>
                <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                    Our work across 8 urban and rural communities creates a demonstration effect, inspiring other areas to prioritize 
