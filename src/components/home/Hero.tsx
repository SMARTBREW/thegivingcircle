...
const FUNDRAISING_DATA = [
  {
    ...
    organizer: "Pads for Freedom Foundation",
    updates: [
  ...
  },
  {
    ...
    organizer: "Pawsitive Protectors Animal Welfare",
    updates: [
  ...
  },
  {
    ...
    organizer: "Uttarakhand Relief Foundation",
    updates: [
  ...
  },
  {
    ...
    daysLeft: 30,
    location: "Schools and Communities Nationwide",
    organizer: "Wings of Hope Education Trust",
    updates: [
  ...
  },
  {
    ...
    organizer: "Bowls of Hope Animal Care",
    updates: [
  ...
  },
  {
    ...
    organizer: "Flood Animal Rescue Network",
    updates: [
