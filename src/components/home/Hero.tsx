...
const FundraisingHero = () => {
  const fundraisingData = [
    {
      ...
      description:
        "Every donation brings hope to families facing medical emergencies. Your contribution directly funds life-saving treatments and gives patients a fighting chance for recovery.",
    ...
    },
    {
      ...
      description:
        "Break the cycle of poverty through education. Your support provides books, uniforms, and school supplies to children who dream of a brighter future but lack the resources.",
      image: "https://savioursfoundation.org/wp-content/uploads/2021/01/ngo-1024x768.jpg",
      category: "Education",
      fullDescription:
        "Education is the most powerful weapon against poverty, but thousands of children in our communities lack access to basic school supplies, uniforms, and learning materials. This campaign provides comprehensive educational support including textbooks, writing materials, school uniforms, nutritious meals, and after-school tutoring programs. We also fund teacher training programs and classroom infrastructure improvements.",
      raised: 28500,
      goal: 75000,
      donors: 156,
      daysLeft: 22,
    ...
    },
    {
      ...
      description:
        "When natural disasters strike, families lose everything. Your donation provides emergency shelter, food, clean water, and helps rebuild communities from the ground up.",
    ...
    },
    {
      ...
      description:
        "Access to clean water shouldn't be a luxury. Help us build wells and water purification systems in remote villages where families walk miles for clean drinking water.",
      image: "https://i.pinimg.com/originals/89/d2/df/89d2df3b22deb8589bbbc0b3dbab5b88.jpg",
      category: "Water Crisis",
      fullDescription:
        "Over 2 billion people worldwide lack access to clean drinking water at home. In remote villages, women and children walk hours daily to collect water that's often contaminated. This campaign funds the construction of deep-water wells, solar-powered water purification systems, and community water storage facilities. We also provide water quality testing and maintenance training to ensure long-term sustainability.",
      raised: 34800,
      goal: 90000,
      donors: 198,
      daysLeft: 30,
    ...
    },
    {
      ...
      description:
        "No child should go to bed hungry. Your support provides nutritious meals, food packages, and sustainable farming solutions to communities facing food insecurity.",
    ...
    },
    {
      ...
      description:
        "Bring medical care to the doorsteps of those who need it most. Fund mobile clinics, medicines, and healthcare workers serving in the most remote and underserved areas.",
      ...
      fullDescription:
        "In remote areas, the nearest hospital can be hundreds of miles away. Our mobile healthcare program brings medical services directly to underserved communities. We operate mobile clinics equipped with diagnostic tools, provide vaccinations, maternal healthcare, and chronic disease management. The program also trains community health workers and establishes telemedicine connections to specialist doctors.",
      raised: 41600,
      goal: 95000,
      donors: 167,
      daysLeft: 25,
    ...
    },
    {
      ...
      description:
        "Rescue, heal, and find loving homes for abandoned and injured animals. Your donation covers veterinary care, shelter, food, and rehabilitation for animals in need.",
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div
        className="absolute inset-0 cursor-pointer transition-all duration-300 hover:scale-105"
      ...
      >
        ...
        />
        {/* Much lighter gradient for clearer image visibility */}
      ...
      {isModalOpen && (
        ...
        >
          <div
            className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto animate-modal-appear"
      ...
      <style>{`
        ...
        .animate-progress-bar {
          animation: progress-bar 1s ease-out 0.3s both;
        }
...
export const Hero = FundraisingHero; 